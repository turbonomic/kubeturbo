...
func (c *TPClient) GetJwtToken(oauth2Token string) (string, error) {
	panic("the program is trying to get jwtToken from TP Client, which should never happen")
}

func (c *TPClient) GetOAuth2AccessToken() (string, error) {
	panic("the program is trying to get oauth2 access token from TP Client, which should never happen")
}

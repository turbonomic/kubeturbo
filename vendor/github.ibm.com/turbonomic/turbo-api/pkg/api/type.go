...
// InputField name indicating the field value is the target subtype
...
type Target struct {
	...
	// sub type for targets which need to have sub category of a type
	// for example RedHatOpenShift is a subtype of Kubernetes

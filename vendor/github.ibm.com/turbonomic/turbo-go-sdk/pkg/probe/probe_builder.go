...
func NewProbeBuilder(probeType, probeCategory, probeUICategory string) *ProbeBuilder {
	return NewProbeBuilderWithSubType(probeType, "", probeCategory, probeUICategory)
}

// Get an instance of ProbeBuilder
func NewProbeBuilderWithSubType(probeType, probeSubType, probeCategory, probeUICategory string) *ProbeBuilder {
	probeBuilder := &ProbeBuilder{}

	// Validate probe type and category
	probeConf, err := NewProbeConfig(probeType, probeSubType, probeCategory, probeUICategory)
	if err != nil {
...
func (pb *ProbeBuilder) Create() (*TurboProbe, error) {
	if pb.builderError != nil {
		glog.Error(pb.builderError.Error())

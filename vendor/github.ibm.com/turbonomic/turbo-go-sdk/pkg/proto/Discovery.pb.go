...
func (CustomAccountDefEntry_PrimitiveValue) EnumDescriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{4, 0}
}
...
func (TargetLinkInfoDTO_TargetLinkType) EnumDescriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{10, 0}
}
...
type DiscoveryResponse struct {
	...
	// Tags that have been discovered in external systems such as Apptio Cloudability.  We enable
	// customers to use tags from their external systems within turbo, for example to filter and
	// create groups.
	ExternalTags []*ExternalTag `protobuf:"bytes,22,rep,name=external_tags,json=externalTags" json:"external_tags,omitempty"`
	// Reources that have been discovered in external systems such as Apptio Cloudability that may
	// also exist in turbo.  We can connect these external resources to internal Turbo entities
	// and add external attributes, like tags, during stitching.
	ExternalResources []*ExternalResourceInfo `protobuf:"bytes,23,rep,name=external_resources,json=externalResources" json:"external_resources,omitempty"`
	// Similar to PriceTable but instead lists the commitment rates, for example AWS Compute or EC2
	// instances saving plan rates.
	CommitmentRates []*CommitmentRates `protobuf:"bytes,24,rep,name=commitment_rates,json=commitmentRates" json:"commitment_rates,omitempty"`
	// Target Information including version
	TargetInfoValues *TargetInfoValues `protobuf:"bytes,25,opt,name=target_info_values,json=targetInfoValues" json:"target_info_values,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *DiscoveryResponse) GetExternalTags() []*ExternalTag {
	if x != nil {
...
func (x *DiscoveryResponse) GetExternalResources() []*ExternalResourceInfo {
	if x != nil {
...
func (x *DiscoveryResponse) GetCommitmentRates() []*CommitmentRates {
	if x != nil {
		return x.CommitmentRates
	}
	return nil
}

func (x *DiscoveryResponse) GetTargetInfoValues() *TargetInfoValues {
	if x != nil {
		return x.TargetInfoValues
	}
	return nil
}

type TargetInfoValues struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TargetVersion *string                `protobuf:"bytes,1,req,name=target_version,json=targetVersion" json:"target_version,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TargetInfoValues) Reset() {
	*x = TargetInfoValues{}
...
func (x *TargetInfoValues) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TargetInfoValues) ProtoMessage() {}

func (x *TargetInfoValues) ProtoReflect() protoreflect.Message {
	mi := &file_Discovery_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TargetInfoValues.ProtoReflect.Descriptor instead.
func (*TargetInfoValues) Descriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{2}
}

func (x *TargetInfoValues) GetTargetVersion() string {
...
func (x *CustomAccountDefEntry) GetFieldType() isCustomAccountDefEntry_FieldType {
	if x != nil {
		return x.FieldType
	}
	return nil
...
func (x *CustomAccountDefEntry) GetPrimitiveValue() CustomAccountDefEntry_PrimitiveValue {
	if x != nil {
		if x, ok := x.FieldType.(*CustomAccountDefEntry_PrimitiveValue_); ok {
...
func (x *CustomAccountDefEntry) GetGroupScope() *CustomAccountDefEntry_GroupScopePropertySet {
	if x != nil {
		if x, ok := x.FieldType.(*CustomAccountDefEntry_GroupScope); ok {
			return x.GroupScope
		}
	}
	return nil
...
func (x *CustomAccountDefEntry) GetEntityScope() *CustomAccountDefEntry_GroupScopePropertySet {
	if x != nil {
		if x, ok := x.FieldType.(*CustomAccountDefEntry_EntityScope); ok {
...
func (x *AccountDefEntry) GetDefinition() isAccountDefEntry_Definition {
	if x != nil {
		return x.Definition
	}
	return nil
...
func (x *AccountDefEntry) GetPredefinedDefinition() string {
	if x != nil {
		if x, ok := x.Definition.(*AccountDefEntry_PredefinedDefinition); ok {
...
func (x *AccountDefEntry) GetCustomDefinition() *CustomAccountDefEntry {
	if x != nil {
		if x, ok := x.Definition.(*AccountDefEntry_CustomDefinition); ok {
...
type ErrorTypeInfo struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Error_Type_Info:
	//
	...
	//	*ErrorTypeInfo_ActionOrchestratorCooldownErrorType_
...
func (x *ErrorTypeInfo) GetError_Type_Info() isErrorTypeInfo_Error_Type_Info {
	if x != nil {
		return x.Error_Type_Info
	}
	return nil
...
func (x *ErrorTypeInfo) GetOther_Error_Type() *ErrorTypeInfo_OtherErrorType {
	if x != nil {
		if x, ok := x.Error_Type_Info.(*ErrorTypeInfo_Other_Error_Type); ok {
...
func (x *ErrorTypeInfo) GetConnectionTimeOutErrorType() *ErrorTypeInfo_ConnectionTimeOutErrorType {
	if x != nil {
		if x, ok := x.Error_Type_Info.(*ErrorTypeInfo_ConnectionTimeOutErrorType_); ok {
...
func (x *ErrorTypeInfo) GetUnauthenticatedErrorType() *ErrorTypeInfo_UnauthenticatedErrorType {
	if x != nil {
		if x, ok := x.Error_Type_Info.(*ErrorTypeInfo_UnauthenticatedErrorType_); ok {
...
func (x *ErrorTypeInfo) GetUnauthorizedErrorType() *ErrorTypeInfo_UnauthorizedErrorType {
	if x != nil {
		if x, ok := x.Error_Type_Info.(*ErrorTypeInfo_UnauthorizedErrorType_); ok {
...
func (x *ErrorTypeInfo) GetTokenUnavailableErrorType() *ErrorTypeInfo_TokenUnavailableErrorType {
	if x != nil {
		if x, ok := x.Error_Type_Info.(*ErrorTypeInfo_TokenUnavailableErrorType_); ok {
...
func (x *ErrorTypeInfo) GetTokenExpiredErrorType() *ErrorTypeInfo_TokenExpiredErrorType {
	if x != nil {
		if x, ok := x.Error_Type_Info.(*ErrorTypeInfo_TokenExpiredErrorType_); ok {
...
func (x *ErrorTypeInfo) GetDataIsMissingErrorType() *ErrorTypeInfo_DataIsMissingErrorType {
	if x != nil {
		if x, ok := x.Error_Type_Info.(*ErrorTypeInfo_DataIsMissingErrorType_); ok {
...
func (x *ErrorTypeInfo) GetVersionNotSupportedErrorType() *ErrorTypeInfo_VersionNotSupportedErrorType {
	if x != nil {
		if x, ok := x.Error_Type_Info.(*ErrorTypeInfo_VersionNotSupportedErrorType_); ok {
...
func (x *ErrorTypeInfo) GetProbeParsingErrorType() *ErrorTypeInfo_ProbeParsingErrorType {
	if x != nil {
		if x, ok := x.Error_Type_Info.(*ErrorTypeInfo_ProbeParsingErrorType_); ok {
...
func (x *ErrorTypeInfo) GetInternalProbeErrorType() *ErrorTypeInfo_InternalProbeErrorType {
	if x != nil {
		if x, ok := x.Error_Type_Info.(*ErrorTypeInfo_InternalProbeErrorType_); ok {
...
func (x *ErrorTypeInfo) GetDuplicationErrorType() *ErrorTypeInfo_DuplicationErrorType {
	if x != nil {
		if x, ok := x.Error_Type_Info.(*ErrorTypeInfo_DuplicationErrorType_); ok {
...
func (x *ErrorTypeInfo) GetDelayedDataErrorType() *ErrorTypeInfo_DelayedDataErrorType {
	if x != nil {
		if x, ok := x.Error_Type_Info.(*ErrorTypeInfo_DelayedDataErrorType_); ok {
...
func (x *ErrorTypeInfo) GetThirdPartyApiFailureErrorType() *ErrorTypeInfo_ThirdPartyApiFailureErrorType {
	if x != nil {
		if x, ok := x.Error_Type_Info.(*ErrorTypeInfo_ThirdPartyApiFailureErrorType_); ok {
...
func (x *ErrorTypeInfo) GetActionOrchestratorCooldownErrorType() *ErrorTypeInfo_ActionOrchestratorCooldownErrorType {
	if x != nil {
		if x, ok := x.Error_Type_Info.(*ErrorTypeInfo_ActionOrchestratorCooldownErrorType_); ok {
			return x.ActionOrchestratorCooldownErrorType
		}
	}
	return nil
}
...
type ErrorTypeInfo_ActionOrchestratorCooldownErrorType_ struct {
	ActionOrchestratorCooldownErrorType *ErrorTypeInfo_ActionOrchestratorCooldownErrorType `protobuf:"bytes,14,opt,name=action_orchestrator_cooldown_error_type,json=actionOrchestratorCooldownErrorType,oneof"`
}
...
func (*ErrorTypeInfo_ActionOrchestratorCooldownErrorType_) isErrorTypeInfo_Error_Type_Info() {}
...
func (*CustomAccountDefEntry_GroupScopeProperty) Descriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{4, 1}
}
...
func (*ErrorTypeInfo_ConnectionTimeOutErrorType) Descriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{7, 1}
}
...
func (*ErrorTypeInfo_UnauthenticatedErrorType) Descriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{7, 2}
}
...
func (*ErrorTypeInfo_UnauthorizedErrorType) Descriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{7, 3}
}
...
func (*ErrorTypeInfo_TokenUnavailableErrorType) Descriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{7, 4}
}
...
func (*ErrorTypeInfo_TokenExpiredErrorType) Descriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{7, 5}
}
...
func (*ErrorTypeInfo_DataIsMissingErrorType) Descriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{7, 6}
}
...
func (*ErrorTypeInfo_VersionNotSupportedErrorType) Descriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{7, 7}
}
...
func (*ErrorTypeInfo_ProbeParsingErrorType) Descriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{7, 8}
}
...
func (*ErrorTypeInfo_InternalProbeErrorType) Descriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{7, 9}
}
...
func (*ErrorTypeInfo_DuplicationErrorType) Descriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{7, 10}
}
...
func (*ErrorTypeInfo_DelayedDataErrorType) Descriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{7, 11}
}
...
type ErrorTypeInfo_ThirdPartyApiFailureErrorType struct {
	...
	// error type of Failure. eg: DESTINATION_CPU_INCOMPATIBLE,
	// DESTINATION_RESOURCE_POOL_INCOMPATIBLE
	ErrorType     *ActionErrorType `protobuf:"varint,3,opt,name=errorType,enum=common_dto.ActionErrorType" json:"errorType,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (*ErrorTypeInfo_ThirdPartyApiFailureErrorType) Descriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{7, 12}
}
...
func (x *ErrorTypeInfo_ThirdPartyApiFailureErrorType) GetErrorType() ActionErrorType {
	if x != nil && x.ErrorType != nil {
		return *x.ErrorType
	}
	return ActionErrorType_DESTINATION_CPU_INCOMPATIBLE
}

// Error type caused when due to too many consecutive fails cooldown for action is enabled.
type ErrorTypeInfo_ActionOrchestratorCooldownErrorType struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Unix timestamp in milliseconds when cooldown ends.
	CooldownEnd   *int64 `protobuf:"varint,1,opt,name=cooldown_end,json=cooldownEnd" json:"cooldown_end,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ErrorTypeInfo_ActionOrchestratorCooldownErrorType) Reset() {
	*x = ErrorTypeInfo_ActionOrchestratorCooldownErrorType{}
	mi := &file_Discovery_proto_msgTypes[30]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ErrorTypeInfo_ActionOrchestratorCooldownErrorType) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ErrorTypeInfo_ActionOrchestratorCooldownErrorType) ProtoMessage() {}

func (x *ErrorTypeInfo_ActionOrchestratorCooldownErrorType) ProtoReflect() protoreflect.Message {
	mi := &file_Discovery_proto_msgTypes[30]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ErrorTypeInfo_ActionOrchestratorCooldownErrorType.ProtoReflect.Descriptor instead.
func (*ErrorTypeInfo_ActionOrchestratorCooldownErrorType) Descriptor() ([]byte, []int) {
	return file_Discovery_proto_rawDescGZIP(), []int{7, 13}
}

func (x *ErrorTypeInfo_ActionOrchestratorCooldownErrorType) GetCooldownEnd() int64 {
...
var file_Discovery_proto_rawDesc = string([]byte{
	...
	0x61, 0x67, 0x65, 0x73, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x22, 0x83, 0x0d, 0x0a, 0x11, 0x44,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x66, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x48, 0x00, 0x52, 0x10, 0x63, 0x75, 0x73, 0x74, 0x6f,
	0x6d, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x22, 0x0a, 0x09, 0x6d,
	0x61, 0x6e, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x3a, 0x04,
	0x74, 0x72, 0x75, 0x65, 0x52, 0x09, 0x6d, 0x61, 0x6e, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x79, 0x12,
	...
	0x6c, 0x75, 0x65, 0x12, 0x37, 0x0a, 0x13, 0x69, 0x73, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x44,
	0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08,
	0x3a, 0x05, 0x66, 0x61, 0x6c, 0x73, 0x65, 0x52, 0x13, 0x69, 0x73, 0x54, 0x61, 0x72, 0x67, 0x65,
	...
	,
	...
	0x12, 0x1e, 0x0a, 0x0a, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x55, 0x75, 0x69, 0x64, 0x18, 0x03,
	...
	,
	...
	,
	...
	,
...
var file_Discovery_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_Discovery_proto_goTypes = []any{
	...
	(*TargetInfoValues)(nil),                                  // 9: common_dto.TargetInfoValues
	(*ProbeStageDetails)(nil),                                 // 10: common_dto.ProbeStageDetails
	(*CustomAccountDefEntry)(nil),                             // 11: common_dto.CustomAccountDefEntry
	(*AccountDefEntry)(nil),                                   // 12: common_dto.AccountDefEntry
	(*ErrorDTO)(nil),                                          // 13: common_dto.ErrorDTO
	(*ErrorTypeInfo)(nil),                                     // 14: common_dto.ErrorTypeInfo
	(*CustomMetadataDTO)(nil),                                 // 15: common_dto.CustomMetadataDTO
	(*AccountValue)(nil),                                      // 16: common_dto.AccountValue
	(*TargetLinkInfoDTO)(nil),                                 // 17: common_dto.TargetLinkInfoDTO
	(*DerivedTargetSpecificationDTO)(nil),                     // 18: common_dto.DerivedTargetSpecificationDTO
	(*EntityData)(nil),                                        // 19: common_dto.EntityData
	(*DiscoveryContextDTO)(nil),                               // 20: common_dto.DiscoveryContextDTO
	(*NoChange)(nil),                                          // 21: common_dto.NoChange
	(*CustomAccountDefEntry_GroupScopePropertySet)(nil),       // 22: common_dto.CustomAccountDefEntry.GroupScopePropertySet
	(*CustomAccountDefEntry_GroupScopeProperty)(nil),          // 23: common_dto.CustomAccountDefEntry.GroupScopeProperty
	(*ErrorTypeInfo_OtherErrorType)(nil),                      // 24: common_dto.ErrorTypeInfo.OtherErrorType
	(*ErrorTypeInfo_ConnectionTimeOutErrorType)(nil),          // 25: common_dto.ErrorTypeInfo.ConnectionTimeOutErrorType
	(*ErrorTypeInfo_UnauthenticatedErrorType)(nil),            // 26: common_dto.ErrorTypeInfo.UnauthenticatedErrorType
	(*ErrorTypeInfo_UnauthorizedErrorType)(nil),               // 27: common_dto.ErrorTypeInfo.UnauthorizedErrorType
	(*ErrorTypeInfo_TokenUnavailableErrorType)(nil),           // 28: common_dto.ErrorTypeInfo.TokenUnavailableErrorType
	(*ErrorTypeInfo_TokenExpiredErrorType)(nil),               // 29: common_dto.ErrorTypeInfo.TokenExpiredErrorType
	(*ErrorTypeInfo_DataIsMissingErrorType)(nil),              // 30: common_dto.ErrorTypeInfo.DataIsMissingErrorType
	(*ErrorTypeInfo_VersionNotSupportedErrorType)(nil),        // 31: common_dto.ErrorTypeInfo.VersionNotSupportedErrorType
	(*ErrorTypeInfo_ProbeParsingErrorType)(nil),               // 32: common_dto.ErrorTypeInfo.ProbeParsingErrorType
	(*ErrorTypeInfo_InternalProbeErrorType)(nil),              // 33: common_dto.ErrorTypeInfo.InternalProbeErrorType
	(*ErrorTypeInfo_DuplicationErrorType)(nil),                // 34: common_dto.ErrorTypeInfo.DuplicationErrorType
	(*ErrorTypeInfo_DelayedDataErrorType)(nil),                // 35: common_dto.ErrorTypeInfo.DelayedDataErrorType
	(*ErrorTypeInfo_ThirdPartyApiFailureErrorType)(nil),       // 36: common_dto.ErrorTypeInfo.ThirdPartyApiFailureErrorType
	(*ErrorTypeInfo_ActionOrchestratorCooldownErrorType)(nil), // 37: common_dto.ErrorTypeInfo.ActionOrchestratorCooldownErrorType
	(*AccountValue_PropertyValueList)(nil),                    // 38: common_dto.AccountValue.PropertyValueList
	nil,                                                       // 39: common_dto.DiscoveryContextDTO.ContextEntryEntry
	nil,                                                       // 40: common_dto.DiscoveryContextDTO.EntityContextEntryEntry
	(*EntityDTO)(nil),                                         // 41: common_dto.EntityDTO
	(*GroupDTO)(nil),                                          // 42: common_dto.GroupDTO
	(*EntityProfileDTO)(nil),                                  // 43: common_dto.EntityProfileDTO
	(*DeploymentProfileDTO)(nil),                              // 44: common_dto.DeploymentProfileDTO
	(*NotificationDTO)(nil),                                   // 45: common_dto.NotificationDTO
	(*NonMarketEntityDTO)(nil),                                // 46: common_dto.NonMarketEntityDTO
	(*FlowDTO)(nil),                                           // 47: common_dto.FlowDTO
	(*CostDataDTO)(nil),                                       // 48: common_dto.CostDataDTO
	(*PriceTable)(nil),                                        // 49: common_dto.PriceTable
	(*Workflow)(nil),                                          // 50: common_dto.Workflow
	(*CloudBillingData)(nil),                                  // 51: common_dto.CloudBillingData
	(*EntityIdentifyingPropertyValues)(nil),                   // 52: common_dto.EntityIdentifyingPropertyValues
	(*CloudCommitmentData)(nil),                               // 53: common_dto.CloudCommitmentData
	(*ActionPolicyDTO)(nil),                                   // 54: common_dto.ActionPolicyDTO
	(*ExternalTag)(nil),                                       // 55: common_dto.ExternalTag
	(*ExternalResourceInfo)(nil),                              // 56: common_dto.ExternalResourceInfo
	(*CommitmentRates)(nil),                                   // 57: common_dto.CommitmentRates
	(CustomTypeDef_MetadataNamespace)(0),                      // 58: common_dto.CustomTypeDef.MetadataNamespace
	(EntityDTO_EntityType)(0),                                 // 59: common_dto.EntityDTO.EntityType
	(ActionErrorType)(0),                                      // 60: common_dto.ActionErrorType
}
var file_Discovery_proto_depIdxs = []int32{
	13, // 0: common_dto.ValidationResponse.errorDTO:type_name -> common_dto.ErrorDTO
	10, // 1: common_dto.ValidationResponse.stages_detail:type_name -> common_dto.ProbeStageDetails
	13, // 2: common_dto.DiscoveryResponse.errorDTO:type_name -> common_dto.ErrorDTO
	41, // 3: common_dto.DiscoveryResponse.entityDTO:type_name -> common_dto.EntityDTO
	42, // 4: common_dto.DiscoveryResponse.discoveredGroup:type_name -> common_dto.GroupDTO
	43, // 5: common_dto.DiscoveryResponse.entityProfile:type_name -> common_dto.EntityProfileDTO
	44, // 6: common_dto.DiscoveryResponse.deploymentProfile:type_name -> common_dto.DeploymentProfileDTO
	45, // 7: common_dto.DiscoveryResponse.notification:type_name -> common_dto.NotificationDTO
	15, // 8: common_dto.DiscoveryResponse.metadataDTO:type_name -> common_dto.CustomMetadataDTO
	18, // 9: common_dto.DiscoveryResponse.derivedTarget:type_name -> common_dto.DerivedTargetSpecificationDTO
	46, // 10: common_dto.DiscoveryResponse.nonMarketEntityDTO:type_name -> common_dto.NonMarketEntityDTO
	47, // 11: common_dto.DiscoveryResponse.flowDTO:type_name -> common_dto.FlowDTO
	20, // 12: common_dto.DiscoveryResponse.discoveryContext:type_name -> common_dto.DiscoveryContextDTO
	48, // 13: common_dto.DiscoveryResponse.costDTO:type_name -> common_dto.CostDataDTO
	49, // 14: common_dto.DiscoveryResponse.priceTable:type_name -> common_dto.PriceTable
	50, // 15: common_dto.DiscoveryResponse.workflow:type_name -> common_dto.Workflow
	21, // 16: common_dto.DiscoveryResponse.no_change:type_name -> common_dto.NoChange
	10, // 17: common_dto.DiscoveryResponse.stages_detail:type_name -> common_dto.ProbeStageDetails
	51, // 18: common_dto.DiscoveryResponse.cloudBillingData:type_name -> common_dto.CloudBillingData
	52, // 19: common_dto.DiscoveryResponse.entity_identifying_property_values:type_name -> common_dto.EntityIdentifyingPropertyValues
	53, // 20: common_dto.DiscoveryResponse.cloud_commitment_data:type_name -> common_dto.CloudCommitmentData
	54, // 21: common_dto.DiscoveryResponse.action_policies:type_name -> common_dto.ActionPolicyDTO
	55, // 22: common_dto.DiscoveryResponse.external_tags:type_name -> common_dto.ExternalTag
	56, // 23: common_dto.DiscoveryResponse.external_resources:type_name -> common_dto.ExternalResourceInfo
	57, // 24: common_dto.DiscoveryResponse.commitment_rates:type_name -> common_dto.CommitmentRates
	9,  // 25: common_dto.DiscoveryResponse.target_info_values:type_name -> common_dto.TargetInfoValues
	1,  // 26: common_dto.ProbeStageDetails.status:type_name -> common_dto.ProbeStageDetails.StageStatus
	10, // 27: common_dto.ProbeStageDetails.subStages:type_name -> common_dto.ProbeStageDetails
	2,  // 28: common_dto.CustomAccountDefEntry.primitive_value:type_name -> common_dto.CustomAccountDefEntry.PrimitiveValue
	22, // 29: common_dto.CustomAccountDefEntry.group_scope:type_name -> common_dto.CustomAccountDefEntry.GroupScopePropertySet
	22, // 30: common_dto.CustomAccountDefEntry.entity_scope:type_name -> common_dto.CustomAccountDefEntry.GroupScopePropertySet
	11, // 31: common_dto.AccountDefEntry.custom_definition:type_name -> common_dto.CustomAccountDefEntry
	4,  // 32: common_dto.ErrorDTO.severity:type_name -> common_dto.ErrorDTO.ErrorSeverity
	3,  // 33: common_dto.ErrorDTO.errorType:type_name -> common_dto.ErrorDTO.ErrorType
	14, // 34: common_dto.ErrorDTO.error_Type_Info:type_name -> common_dto.ErrorTypeInfo
	24, // 35: common_dto.ErrorTypeInfo.other_Error_Type:type_name -> common_dto.ErrorTypeInfo.OtherErrorType
	25, // 36: common_dto.ErrorTypeInfo.connection_time_out_error_type:type_name -> common_dto.ErrorTypeInfo.ConnectionTimeOutErrorType
	26, // 37: common_dto.ErrorTypeInfo.unauthenticated_error_type:type_name -> common_dto.ErrorTypeInfo.UnauthenticatedErrorType
	27, // 38: common_dto.ErrorTypeInfo.unauthorized_error_type:type_name -> common_dto.ErrorTypeInfo.UnauthorizedErrorType
	28, // 39: common_dto.ErrorTypeInfo.token_unavailable_error_type:type_name -> common_dto.ErrorTypeInfo.TokenUnavailableErrorType
	29, // 40: common_dto.ErrorTypeInfo.token_expired_error_type:type_name -> common_dto.ErrorTypeInfo.TokenExpiredErrorType
	30, // 41: common_dto.ErrorTypeInfo.data_is_missing_error_type:type_name -> common_dto.ErrorTypeInfo.DataIsMissingErrorType
	31, // 42: common_dto.ErrorTypeInfo.version_not_supported_error_type:type_name -> common_dto.ErrorTypeInfo.VersionNotSupportedErrorType
	32, // 43: common_dto.ErrorTypeInfo.probe_parsing_error_type:type_name -> common_dto.ErrorTypeInfo.ProbeParsingErrorType
	33, // 44: common_dto.ErrorTypeInfo.internal_probe_error_type:type_name -> common_dto.ErrorTypeInfo.InternalProbeErrorType
	34, // 45: common_dto.ErrorTypeInfo.duplication_error_type:type_name -> common_dto.ErrorTypeInfo.DuplicationErrorType
	35, // 46: common_dto.ErrorTypeInfo.delayed_data_error_type:type_name -> common_dto.ErrorTypeInfo.DelayedDataErrorType
	36, // 47: common_dto.ErrorTypeInfo.third_party_api_failure_error_type:type_name -> common_dto.ErrorTypeInfo.ThirdPartyApiFailureErrorType
	37, // 48: common_dto.ErrorTypeInfo.action_orchestrator_cooldown_error_type:type_name -> common_dto.ErrorTypeInfo.ActionOrchestratorCooldownErrorType
	58, // 49: common_dto.CustomMetadataDTO.namespace:type_name -> common_dto.CustomTypeDef.MetadataNamespace
	5,  // 50: common_dto.CustomMetadataDTO.dataType:type_name -> common_dto.CustomMetadataDTO.Type
	38, // 51: common_dto.AccountValue.groupScopePropertyValues:type_name -> common_dto.AccountValue.PropertyValueList
	6,  // 52: common_dto.TargetLinkInfoDTO.link_type:type_name -> common_dto.TargetLinkInfoDTO.TargetLinkType
	16, // 53: common_dto.DerivedTargetSpecificationDTO.accountValue:type_name -> common_dto.AccountValue
	17, // 54: common_dto.DerivedTargetSpecificationDTO.target_link_info:type_name -> common_dto.TargetLinkInfoDTO
	39, // 55: common_dto.DiscoveryContextDTO.contextEntry:type_name -> common_dto.DiscoveryContextDTO.ContextEntryEntry
	40, // 56: common_dto.DiscoveryContextDTO.entityContextEntry:type_name -> common_dto.DiscoveryContextDTO.EntityContextEntryEntry
	59, // 57: common_dto.CustomAccountDefEntry.GroupScopePropertySet.entityType:type_name -> common_dto.EntityDTO.EntityType
	23, // 58: common_dto.CustomAccountDefEntry.GroupScopePropertySet.property:type_name -> common_dto.CustomAccountDefEntry.GroupScopeProperty
	60, // 59: common_dto.ErrorTypeInfo.ThirdPartyApiFailureErrorType.errorType:type_name -> common_dto.ActionErrorType
	19, // 60: common_dto.DiscoveryContextDTO.EntityContextEntryEntry.value:type_name -> common_dto.EntityData
...
func file_Discovery_proto_init() {
	...
	file_Discovery_proto_msgTypes[7].OneofWrappers = []any{
		...
		(*ErrorTypeInfo_ActionOrchestratorCooldownErrorType_)(nil),
	}
	type x struct{}

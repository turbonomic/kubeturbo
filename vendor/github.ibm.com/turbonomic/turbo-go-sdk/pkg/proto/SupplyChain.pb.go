...
func (x *MergedEntityMetadata_MatchingData) GetMatchingData() isMergedEntityMetadata_MatchingData_MatchingData {
	if x != nil {
		return x.MatchingData
	}
	return nil
...
func (x *MergedEntityMetadata_MatchingData) GetMatchingProperty() *MergedEntityMetadata_EntityPropertyName {
	if x != nil {
		if x, ok := x.MatchingData.(*MergedEntityMetadata_MatchingData_MatchingProperty); ok {
...
func (x *MergedEntityMetadata_MatchingData) GetMatchingField() *MergedEntityMetadata_EntityField {
	if x != nil {
		if x, ok := x.MatchingData.(*MergedEntityMetadata_MatchingData_MatchingField); ok {
...
func (x *MergedEntityMetadata_MatchingData) GetMatchingEntityOid() *MergedEntityMetadata_EntityOid {
	if x != nil {
		if x, ok := x.MatchingData.(*MergedEntityMetadata_MatchingData_MatchingEntityOid); ok {
...
var file_SupplyChain_proto_rawDesc = string([]byte{
...
var (
	...
	file_SupplyChain_proto_rawDescData []byte
)

func file_SupplyChain_proto_rawDescGZIP() []byte {
	file_SupplyChain_proto_rawDescOnce.Do(func() {
		file_SupplyChain_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_SupplyChain_proto_rawDesc), len(file_SupplyChain_proto_rawDesc)))
	})
...
func file_SupplyChain_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_SupplyChain_proto_rawDesc), len(file_SupplyChain_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   18,
			NumExtensions: 0,
			NumServices:   0,

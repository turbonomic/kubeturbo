...
func (x *NonMarketEntityDTO) GetEntityData() isNonMarketEntityDTO_EntityData {
	if x != nil {
		return x.EntityData
	}
	return nil
...
func (x *NonMarketEntityDTO) GetCloudServiceData() *NonMarketEntityDTO_CloudServiceData {
	if x != nil {
		if x, ok := x.EntityData.(*NonMarketEntityDTO_CloudServiceData_); ok {
...
func (x *NonMarketEntityDTO) GetPlanDestinationData() *NonMarketEntityDTO_PlanDestinationData {
	if x != nil {
		if x, ok := x.EntityData.(*NonMarketEntityDTO_PlanDestinationData_); ok {
...
func (x *NonMarketEntityDTO) GetCloudCommitmentData() *NonMarketEntityDTO_CloudCommitmentData {
	if x != nil {
		if x, ok := x.EntityData.(*NonMarketEntityDTO_CloudCommitmentData_); ok {
...
func (x *NonMarketEntityDTO_CloudCommitmentData_CloudCommitmentDataBucket_CloudCommitmentDataPoint_CloudCommitmentAmount) GetValue() isNonMarketEntityDTO_CloudCommitmentData_CloudCommitmentDataBucket_CloudCommitmentDataPoint_CloudCommitmentAmount_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *NonMarketEntityDTO_CloudCommitmentData_CloudCommitmentDataBucket_CloudCommitmentDataPoint_CloudCommitmentAmount) GetAmount() *CurrencyAmount {
	if x != nil {
		if x, ok := x.Value.(*NonMarketEntityDTO_CloudCommitmentData_CloudCommitmentDataBucket_CloudCommitmentDataPoint_CloudCommitmentAmount_Amount); ok {
			return x.Amount
		}
	}
	return nil
...
func (x *NonMarketEntityDTO_CloudCommitmentData_CloudCommitmentDataBucket_CloudCommitmentDataPoint_CloudCommitmentAmount) GetCoupons() float32 {
	if x != nil {
		if x, ok := x.Value.(*NonMarketEntityDTO_CloudCommitmentData_CloudCommitmentDataBucket_CloudCommitmentDataPoint_CloudCommitmentAmount_Coupons); ok {
			return x.Coupons
		}
	}
	return 0
...
var file_NonMarketEntityDTO_proto_rawDesc = string([]byte{
...
var (
	...
	file_NonMarketEntityDTO_proto_rawDescData []byte
)

func file_NonMarketEntityDTO_proto_rawDescGZIP() []byte {
	file_NonMarketEntityDTO_proto_rawDescOnce.Do(func() {
		file_NonMarketEntityDTO_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_NonMarketEntityDTO_proto_rawDesc), len(file_NonMarketEntityDTO_proto_rawDesc)))
	})
...
var file_NonMarketEntityDTO_proto_goTypes = []any{
...
func file_NonMarketEntityDTO_proto_init() {
	...
	file_NonMarketEntityDTO_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_NonMarketEntityDTO_proto_msgTypes[8].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_NonMarketEntityDTO_proto_rawDesc), len(file_NonMarketEntityDTO_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,

...
func (x *EntityProfileDTO) GetEntityTypeSpecificData() isEntityProfileDTO_EntityTypeSpecificData {
	if x != nil {
		return x.EntityTypeSpecificData
	}
	return nil
}
...
func (x *EntityProfileDTO) GetVmProfileDTO() *EntityProfileDTO_VMProfileDTO {
	if x != nil {
		if x, ok := x.EntityTypeSpecificData.(*EntityProfileDTO_VmProfileDTO); ok {
...
func (x *EntityProfileDTO) GetPmProfileDTO() *EntityProfileDTO_PMProfileDTO {
	if x != nil {
		if x, ok := x.EntityTypeSpecificData.(*EntityProfileDTO_PmProfileDTO); ok {
...
func (x *EntityProfileDTO) GetDbProfileDTO() *EntityProfileDTO_DBProfileDTO {
	if x != nil {
		if x, ok := x.EntityTypeSpecificData.(*EntityProfileDTO_DbProfileDTO); ok {
...
var file_ProfileDTO_proto_rawDesc = string([]byte{
...
var (
	...
	file_ProfileDTO_proto_rawDescData []byte
)

func file_ProfileDTO_proto_rawDescGZIP() []byte {
	file_ProfileDTO_proto_rawDescOnce.Do(func() {
		file_ProfileDTO_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ProfileDTO_proto_rawDesc), len(file_ProfileDTO_proto_rawDesc)))
	})
...
var file_ProfileDTO_proto_goTypes = []any{
...
func file_ProfileDTO_proto_init() {
	...
	file_ProfileDTO_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ProfileDTO_proto_rawDesc), len(file_ProfileDTO_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,

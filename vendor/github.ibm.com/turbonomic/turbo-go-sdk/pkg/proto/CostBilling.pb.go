...
var file_CostBilling_proto_rawDesc = string([]byte{
...
var (
	...
	file_CostBilling_proto_rawDescData []byte
)

func file_CostBilling_proto_rawDescGZIP() []byte {
	file_CostBilling_proto_rawDescOnce.Do(func() {
		file_CostBilling_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_CostBilling_proto_rawDesc), len(file_CostBilling_proto_rawDesc)))
	})
...
func file_CostBilling_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_CostBilling_proto_rawDesc), len(file_CostBilling_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,

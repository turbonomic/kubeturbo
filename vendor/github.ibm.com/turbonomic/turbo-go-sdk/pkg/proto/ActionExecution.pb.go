...
type ActionErrorType int32

const (
	ActionErrorType_DESTINATION_CPU_INCOMPATIBLE           ActionErrorType = 1
	ActionErrorType_DESTINATION_RESOURCE_POOL_INCOMPATIBLE ActionErrorType = 2
)

// Enum value maps for ActionErrorType.
var (
	ActionErrorType_name = map[int32]string{
		1: "DESTINATION_CPU_INCOMPATIBLE",
		2: "DESTINATION_RESOURCE_POOL_INCOMPATIBLE",
	}
	ActionErrorType_value = map[string]int32{
		"DESTINATION_CPU_INCOMPATIBLE":           1,
		"DESTINATION_RESOURCE_POOL_INCOMPATIBLE": 2,
	}
)

func (x ActionErrorType) Enum() *ActionErrorType {
	p := new(ActionErrorType)
	*p = x
	return p
}

func (x ActionErrorType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ActionErrorType) Descriptor() protoreflect.EnumDescriptor {
	return file_ActionExecution_proto_enumTypes[1].Descriptor()
}

func (ActionErrorType) Type() protoreflect.EnumType {
	return &file_ActionExecution_proto_enumTypes[1]
}

func (x ActionErrorType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Do not use.
func (x *ActionErrorType) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
	*x = ActionErrorType(num)
	return nil
}

// Deprecated: Use ActionErrorType.Descriptor instead.
func (ActionErrorType) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	ActionExecutionDTO_CLOUD_OPTIMIZER ActionExecutionDTO_ActionSource = 3
	ActionExecutionDTO_BUY_RI          ActionExecutionDTO_ActionSource = 4
)
...
const (
	...
	ActionItemDTO_ALLOCATE         ActionItemDTO_ActionType = 26
	ActionItemDTO_BUY_RI           ActionItemDTO_ActionType = 27
	// Grant access to resources within turbo. Currently this action type is used for
	// repository entities to grant s3 access to read terraform state files in turbo for
	// stitching iac managed entities.
	ActionItemDTO_GRANT ActionItemDTO_ActionType = 28
)
...
func (ActionItemDTO_Risk_Category) EnumDescriptor() ([]byte, []int) {
	return file_ActionExecution_proto_rawDescGZIP(), []int{13, 3, 0}
}
...
func (ActionItemDTO_Risk_Severity) EnumDescriptor() ([]byte, []int) {
	return file_ActionExecution_proto_rawDescGZIP(), []int{13, 3, 1}
}
...
func (Workflow_ActionScriptPhase) Descriptor() protoreflect.EnumDescriptor {
	return file_ActionExecution_proto_enumTypes[8].Descriptor()
}

func (Workflow_ActionScriptPhase) Type() protoreflect.EnumType {
	return &file_ActionExecution_proto_enumTypes[8]
}
...
func (x *ActionMergePolicyDTO) GetActionSpec() isActionMergePolicyDTO_ActionSpec {
	if x != nil {
		return x.ActionSpec
	}
	return nil
...
func (x *ActionMergePolicyDTO) GetResizeSpec() *ResizeMergeSpec {
	if x != nil {
		if x, ok := x.ActionSpec.(*ActionMergePolicyDTO_ResizeSpec); ok {
			return x.ResizeSpec
		}
	}
	return nil
...
func (x *ActionMergePolicyDTO) GetScaleSpec() *ScaleMergeSpec {
	if x != nil {
		if x, ok := x.ActionSpec.(*ActionMergePolicyDTO_ScaleSpec); ok {
			return x.ScaleSpec
		}
	}
	return nil
...
func (x *ActionMergePolicyDTO) GetMoveSpec() *MoveMergeSpec {
	if x != nil {
		if x, ok := x.ActionSpec.(*ActionMergePolicyDTO_MoveSpec); ok {
			return x.MoveSpec
		}
	}
	return nil
...
func (x *ActionMergePolicyDTO) GetProvisionSpec() *ProvisionMergeSpec {
	if x != nil {
		if x, ok := x.ActionSpec.(*ActionMergePolicyDTO_ProvisionSpec); ok {
...
func (x *ActionMergePolicyDTO) GetHorizontalScaleSpec() *HorizontalScaleMergeSpec {
	if x != nil {
		if x, ok := x.ActionSpec.(*ActionMergePolicyDTO_HorizontalScaleSpec); ok {
...
func (x *ActionMergeExecutionTarget) GetExecutionTarget() isActionMergeExecutionTarget_ExecutionTarget {
	if x != nil {
...
func (x *ActionMergeExecutionTarget) GetMergeTarget() *ActionMergeTargetData {
	if x != nil {
		if x, ok := x.ExecutionTarget.(*ActionMergeExecutionTarget_MergeTarget); ok {
...
func (x *ActionMergeExecutionTarget) GetChainedMergeTarget() *ChainedActionMergeTargetData {
	if x != nil {
		if x, ok := x.ExecutionTarget.(*ActionMergeExecutionTarget_ChainedMergeTarget); ok {
...
type ActionItemDTO struct {
	...
	//
	// Deprecated: Marked as deprecated in ActionExecution.proto.
	...
	// List of any related merge policy applied on entities
	MergeEntityPolicies []*ActionItemDTO_MergeEntityPolicy `protobuf:"bytes,23,rep,name=merge_entity_policies,json=mergeEntityPolicies" json:"merge_entity_policies,omitempty"`
	// List of settings needed for action execution
	ActionExecutionSettings map[string]string `protobuf:"bytes,24,rep,name=actionExecutionSettings" json:"actionExecutionSettings,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *ActionItemDTO) GetMergeEntityPolicies() []*ActionItemDTO_MergeEntityPolicy {
	if x != nil {
		return x.MergeEntityPolicies
	}
	return nil
}

func (x *ActionItemDTO) GetActionExecutionSettings() map[string]string {
	if x != nil {
		return x.ActionExecutionSettings
	}
	return nil
}
...
func (x *ActionPolicyDTO_ActionPolicyElement) GetScope() isActionPolicyDTO_ActionPolicyElement_Scope {
	if x != nil {
		return x.Scope
	}
	return nil
...
func (x *ActionPolicyDTO_ActionPolicyElement) GetProviderScope() *ActionPolicyDTO_ActionPolicyElement_ProviderScope {
	if x != nil {
		if x, ok := x.Scope.(*ActionPolicyDTO_ActionPolicyElement_ProviderScope_); ok {
...
func (x *ActionPolicyDTO_ActionPolicyElement) GetCommodityScope() *ActionPolicyDTO_ActionPolicyElement_CommodityScope {
	if x != nil {
		if x, ok := x.Scope.(*ActionPolicyDTO_ActionPolicyElement_CommodityScope_); ok {
...
type ActionMergePolicyDTO_EntityFilter struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to EntityFilterProps:
	//
...
func (x *ActionMergePolicyDTO_EntityFilter) GetEntityFilterProps() isActionMergePolicyDTO_EntityFilter_EntityFilterProps {
	if x != nil {
		return x.EntityFilterProps
	}
	return nil
}
...
func (x *ActionMergePolicyDTO_EntityFilter) GetContainerPodData() *EntityDTO_ContainerPodData {
	if x != nil {
		if x, ok := x.EntityFilterProps.(*ActionMergePolicyDTO_EntityFilter_ContainerPodData); ok {
...
func (x *ActionMergeTargetData_EntityRelationship) GetEntityRelationship() isActionMergeTargetData_EntityRelationship_EntityRelationship {
	if x != nil {
...
func (x *ActionMergeTargetData_EntityRelationship) GetConnectionType() ConnectedEntity_ConnectionType {
	if x != nil {
		if x, ok := x.EntityRelationship.(*ActionMergeTargetData_EntityRelationship_ConnectionType); ok {
...
type ActionItemDTO_MergeEntityPolicy struct {
	...
	// Enable create resource pool flag or not
	EnableCreateResourcePool *bool `protobuf:"varint,3,opt,name=enable_create_resource_pool,json=enableCreateResourcePool,def=0" json:"enable_create_resource_pool,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}

// Default values for ActionItemDTO_MergeEntityPolicy fields.
const (
	Default_ActionItemDTO_MergeEntityPolicy_EnableCreateResourcePool = bool(false)
)
...
func (x *ActionItemDTO_MergeEntityPolicy) GetEnableCreateResourcePool() bool {
	if x != nil && x.EnableCreateResourcePool != nil {
		return *x.EnableCreateResourcePool
	}
	return Default_ActionItemDTO_MergeEntityPolicy_EnableCreateResourcePool
}
...
func (*ActionItemDTO_MergedEntity) Descriptor() ([]byte, []int) {
	return file_ActionExecution_proto_rawDescGZIP(), []int{13, 5}
}
...
func (x *Workflow_Property) Reset() {
	*x = Workflow_Property{}
	mi := &file_ActionExecution_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_ActionExecution_proto_rawDesc = string([]byte{
	...
	0x52, 0x09, 0x61, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x61, 0x6c, 0x73, 0x22, 0xef, 0x05, 0x0a, 0x12,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x47, 0x10, 0x0a, 0x2a, 0x5f, 0x0a, 0x0f, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x72, 0x72,
	0x6f, 0x72, 0x54, 0x79, 0x70, 0x65, 0x12, 0x20, 0x0a, 0x1c, 0x44, 0x45, 0x53, 0x54, 0x49, 0x4e,
	0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x43, 0x50, 0x55, 0x5f, 0x49, 0x4e, 0x43, 0x4f, 0x4d, 0x50,
	0x41, 0x54, 0x49, 0x42, 0x4c, 0x45, 0x10, 0x01, 0x12, 0x2a, 0x0a, 0x26, 0x44, 0x45, 0x53, 0x54,
	0x49, 0x4e, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x52, 0x45, 0x53, 0x4f, 0x55, 0x52, 0x43, 0x45,
	0x5f, 0x50, 0x4f, 0x4f, 0x4c, 0x5f, 0x49, 0x4e, 0x43, 0x4f, 0x4d, 0x50, 0x41, 0x54, 0x49, 0x42,
	0x4c, 0x45, 0x10, 0x02, 0x42, 0x64, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x6d, 0x74, 0x75,
...
var (
	...
	file_ActionExecution_proto_rawDescData []byte
)

func file_ActionExecution_proto_rawDescGZIP() []byte {
	file_ActionExecution_proto_rawDescOnce.Do(func() {
		file_ActionExecution_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ActionExecution_proto_rawDesc), len(file_ActionExecution_proto_rawDesc)))
	})
	return file_ActionExecution_proto_rawDescData
}

var file_ActionExecution_proto_enumTypes = make([]protoimpl.EnumInfo, 9)
var file_ActionExecution_proto_msgTypes = make([]protoimpl.MessageInfo, 35)
var file_ActionExecution_proto_goTypes = []any{
	(ActionResponseState)(0),                                   // 0: common_dto.ActionResponseState
	(ActionErrorType)(0),                                       // 1: common_dto.ActionErrorType
	(ActionPolicyDTO_ActionCapability)(0),                      // 2: common_dto.ActionPolicyDTO.ActionCapability
	(ActionExecutionDTO_ActionSource)(0),                       // 3: common_dto.ActionExecutionDTO.ActionSource
	(ActionItemDTO_ActionType)(0),                              // 4: common_dto.ActionItemDTO.ActionType
	(ActionItemDTO_CommodityAttribute)(0),                      // 5: common_dto.ActionItemDTO.CommodityAttribute
	(ActionItemDTO_Risk_Category)(0),                           // 6: common_dto.ActionItemDTO.Risk.Category
	(ActionItemDTO_Risk_Severity)(0),                           // 7: common_dto.ActionItemDTO.Risk.Severity
	(Workflow_ActionScriptPhase)(0),                            // 8: common_dto.Workflow.ActionScriptPhase
	(*ActionPolicyDTO)(nil),                                    // 9: common_dto.ActionPolicyDTO
	(*ActionMergePolicyDTO)(nil),                               // 10: common_dto.ActionMergePolicyDTO
	(*ActionMergeExecutionTarget)(nil),                         // 11: common_dto.ActionMergeExecutionTarget
	(*ActionMergeTargetData)(nil),                              // 12: common_dto.ActionMergeTargetData
	(*ChainedActionMergeTargetData)(nil),                       // 13: common_dto.ChainedActionMergeTargetData
	(*ResizeMergeSpec)(nil),                                    // 14: common_dto.ResizeMergeSpec
	(*ScaleMergeSpec)(nil),                                     // 15: common_dto.ScaleMergeSpec
	(*ProvisionMergeSpec)(nil),                                 // 16: common_dto.ProvisionMergeSpec
	(*MoveMergeSpec)(nil),                                      // 17: common_dto.MoveMergeSpec
	(*HorizontalScaleMergeSpec)(nil),                           // 18: common_dto.HorizontalScaleMergeSpec
	(*ActionApprovals)(nil),                                    // 19: common_dto.ActionApprovals
	(*CombinedApprovals)(nil),                                  // 20: common_dto.CombinedApprovals
	(*ActionExecutionDTO)(nil),                                 // 21: common_dto.ActionExecutionDTO
	(*ActionItemDTO)(nil),                                      // 22: common_dto.ActionItemDTO
	(*Workflow)(nil),                                           // 23: common_dto.Workflow
	(*ActionErrorDTO)(nil),                                     // 24: common_dto.ActionErrorDTO
	(*ActionEventDTO)(nil),                                     // 25: common_dto.ActionEventDTO
	(*ExternalActionInfo)(nil),                                 // 26: common_dto.ExternalActionInfo
	(*ActionPolicyDTO_ActionPolicyElement)(nil),                // 27: common_dto.ActionPolicyDTO.ActionPolicyElement
	(*ActionPolicyDTO_ActionPolicyElement_ProviderScope)(nil),  // 28: common_dto.ActionPolicyDTO.ActionPolicyElement.ProviderScope
	(*ActionPolicyDTO_ActionPolicyElement_CommodityScope)(nil), // 29: common_dto.ActionPolicyDTO.ActionPolicyElement.CommodityScope
	(*ActionMergePolicyDTO_EntityFilter)(nil),                  // 30: common_dto.ActionMergePolicyDTO.EntityFilter
	(*ActionMergeTargetData_EntityRelationship)(nil),           // 31: common_dto.ActionMergeTargetData.EntityRelationship
	(*ChainedActionMergeTargetData_TargetDataLink)(nil),        // 32: common_dto.ChainedActionMergeTargetData.TargetDataLink
	(*ResizeMergeSpec_CommodityMergeData)(nil),                 // 33: common_dto.ResizeMergeSpec.CommodityMergeData
	(*ScaleMergeSpec_CommodityMergeData)(nil),                  // 34: common_dto.ScaleMergeSpec.CommodityMergeData
	(*HorizontalScaleMergeSpec_CommodityMergeData)(nil),        // 35: common_dto.HorizontalScaleMergeSpec.CommodityMergeData
	nil,                                // 36: common_dto.ActionItemDTO.ActionExecutionSettingsEntry
	(*ActionItemDTO_ProviderInfo)(nil), // 37: common_dto.ActionItemDTO.ProviderInfo
	(*ActionItemDTO_ExecutionCharacteristics)(nil), // 38: common_dto.ActionItemDTO.ExecutionCharacteristics
	(*ActionItemDTO_Risk)(nil),                     // 39: common_dto.ActionItemDTO.Risk
	(*ActionItemDTO_MergeEntityPolicy)(nil),        // 40: common_dto.ActionItemDTO.MergeEntityPolicy
	(*ActionItemDTO_MergedEntity)(nil),             // 41: common_dto.ActionItemDTO.MergedEntity
	(*Workflow_Parameter)(nil),                     // 42: common_dto.Workflow.Parameter
	(*Workflow_Property)(nil),                      // 43: common_dto.Workflow.Property
	(EntityDTO_EntityType)(0),                      // 44: common_dto.EntityDTO.EntityType
	(*EntityDTO)(nil),                              // 45: common_dto.EntityDTO
	(*CommodityDTO)(nil),                           // 46: common_dto.CommodityDTO
	(*EntityProfileDTO)(nil),                       // 47: common_dto.EntityProfileDTO
	(*ContextData)(nil),                            // 48: common_dto.ContextData
	(CommodityDTO_CommodityType)(0),                // 49: common_dto.CommodityDTO.CommodityType
	(*EntityDTO_ContainerPodData)(nil),             // 50: common_dto.EntityDTO.ContainerPodData
	(ConnectedEntity_ConnectionType)(0),            // 51: common_dto.ConnectedEntity.ConnectionType
}
var file_ActionExecution_proto_depIdxs = []int32{
	44, // 0: common_dto.ActionPolicyDTO.entityType:type_name -> common_dto.EntityDTO.EntityType
	27, // 1: common_dto.ActionPolicyDTO.policyElement:type_name -> common_dto.ActionPolicyDTO.ActionPolicyElement
	44, // 2: common_dto.ActionMergePolicyDTO.entityType:type_name -> common_dto.EntityDTO.EntityType
	11, // 3: common_dto.ActionMergePolicyDTO.executionTargets:type_name -> common_dto.ActionMergeExecutionTarget
	14, // 4: common_dto.ActionMergePolicyDTO.resizeSpec:type_name -> common_dto.ResizeMergeSpec
	15, // 5: common_dto.ActionMergePolicyDTO.scaleSpec:type_name -> common_dto.ScaleMergeSpec
	17, // 6: common_dto.ActionMergePolicyDTO.moveSpec:type_name -> common_dto.MoveMergeSpec
	16, // 7: common_dto.ActionMergePolicyDTO.provisionSpec:type_name -> common_dto.ProvisionMergeSpec
	18, // 8: common_dto.ActionMergePolicyDTO.horizontalScaleSpec:type_name -> common_dto.HorizontalScaleMergeSpec
	30, // 9: common_dto.ActionMergePolicyDTO.entityFilters:type_name -> common_dto.ActionMergePolicyDTO.EntityFilter
	12, // 10: common_dto.ActionMergeExecutionTarget.mergeTarget:type_name -> common_dto.ActionMergeTargetData
	13, // 11: common_dto.ActionMergeExecutionTarget.chainedMergeTarget:type_name -> common_dto.ChainedActionMergeTargetData
	44, // 12: common_dto.ActionMergeTargetData.relatedTo:type_name -> common_dto.EntityDTO.EntityType
	31, // 13: common_dto.ActionMergeTargetData.relatedBy:type_name -> common_dto.ActionMergeTargetData.EntityRelationship
	32, // 14: common_dto.ChainedActionMergeTargetData.targetLinks:type_name -> common_dto.ChainedActionMergeTargetData.TargetDataLink
	33, // 15: common_dto.ResizeMergeSpec.commodityData:type_name -> common_dto.ResizeMergeSpec.CommodityMergeData
	34, // 16: common_dto.ScaleMergeSpec.commodityData:type_name -> common_dto.ScaleMergeSpec.CommodityMergeData
	44, // 17: common_dto.MoveMergeSpec.providerType:type_name -> common_dto.EntityDTO.EntityType
	35, // 18: common_dto.HorizontalScaleMergeSpec.commodityData:type_name -> common_dto.HorizontalScaleMergeSpec.CommodityMergeData
	20, // 19: common_dto.ActionApprovals.combinedApprovals:type_name -> common_dto.CombinedApprovals
	21, // 20: common_dto.CombinedApprovals.approvals:type_name -> common_dto.ActionExecutionDTO
	4,  // 21: common_dto.ActionExecutionDTO.actionType:type_name -> common_dto.ActionItemDTO.ActionType
	22, // 22: common_dto.ActionExecutionDTO.actionItem:type_name -> common_dto.ActionItemDTO
	23, // 23: common_dto.ActionExecutionDTO.workflow:type_name -> common_dto.Workflow
	0,  // 24: common_dto.ActionExecutionDTO.actionState:type_name -> common_dto.ActionResponseState
	23, // 25: common_dto.ActionExecutionDTO.workflows:type_name -> common_dto.Workflow
	3,  // 26: common_dto.ActionExecutionDTO.source:type_name -> common_dto.ActionExecutionDTO.ActionSource
	4,  // 27: common_dto.ActionItemDTO.actionType:type_name -> common_dto.ActionItemDTO.ActionType
	45, // 28: common_dto.ActionItemDTO.targetSE:type_name -> common_dto.EntityDTO
	45, // 29: common_dto.ActionItemDTO.hostedBySE:type_name -> common_dto.EntityDTO
	45, // 30: common_dto.ActionItemDTO.currentSE:type_name -> common_dto.EntityDTO
	45, // 31: common_dto.ActionItemDTO.newSE:type_name -> common_dto.EntityDTO
	46, // 32: common_dto.ActionItemDTO.currentComm:type_name -> common_dto.CommodityDTO
	46, // 33: common_dto.ActionItemDTO.newComm:type_name -> common_dto.CommodityDTO
	5,  // 34: common_dto.ActionItemDTO.commodityAttribute:type_name -> common_dto.ActionItemDTO.CommodityAttribute
	37, // 35: common_dto.ActionItemDTO.providers:type_name -> common_dto.ActionItemDTO.ProviderInfo
	47, // 36: common_dto.ActionItemDTO.entityProfileDTO:type_name -> common_dto.EntityProfileDTO
	48, // 37: common_dto.ActionItemDTO.contextData:type_name -> common_dto.ContextData
	45, // 38: common_dto.ActionItemDTO.relatedRI:type_name -> common_dto.EntityDTO
	38, // 39: common_dto.ActionItemDTO.characteristics:type_name -> common_dto.ActionItemDTO.ExecutionCharacteristics
	39, // 40: common_dto.ActionItemDTO.risk:type_name -> common_dto.ActionItemDTO.Risk
	40, // 41: common_dto.ActionItemDTO.merge_entity_policy:type_name -> common_dto.ActionItemDTO.MergeEntityPolicy
	40, // 42: common_dto.ActionItemDTO.merge_entity_policies:type_name -> common_dto.ActionItemDTO.MergeEntityPolicy
	36, // 43: common_dto.ActionItemDTO.actionExecutionSettings:type_name -> common_dto.ActionItemDTO.ActionExecutionSettingsEntry
	42, // 44: common_dto.Workflow.param:type_name -> common_dto.Workflow.Parameter
	43, // 45: common_dto.Workflow.property:type_name -> common_dto.Workflow.Property
	44, // 46: common_dto.Workflow.entityType:type_name -> common_dto.EntityDTO.EntityType
	4,  // 47: common_dto.Workflow.actionType:type_name -> common_dto.ActionItemDTO.ActionType
	8,  // 48: common_dto.Workflow.phase:type_name -> common_dto.Workflow.ActionScriptPhase
	21, // 49: common_dto.ActionEventDTO.action:type_name -> common_dto.ActionExecutionDTO
	0,  // 50: common_dto.ActionEventDTO.oldState:type_name -> common_dto.ActionResponseState
	0,  // 51: common_dto.ActionEventDTO.newState:type_name -> common_dto.ActionResponseState
	4,  // 52: common_dto.ActionPolicyDTO.ActionPolicyElement.actionType:type_name -> common_dto.ActionItemDTO.ActionType
	2,  // 53: common_dto.ActionPolicyDTO.ActionPolicyElement.actionCapability:type_name -> common_dto.ActionPolicyDTO.ActionCapability
	28, // 54: common_dto.ActionPolicyDTO.ActionPolicyElement.providerScope:type_name -> common_dto.ActionPolicyDTO.ActionPolicyElement.ProviderScope
	29, // 55: common_dto.ActionPolicyDTO.ActionPolicyElement.commodityScope:type_name -> common_dto.ActionPolicyDTO.ActionPolicyElement.CommodityScope
	44, // 56: common_dto.ActionPolicyDTO.ActionPolicyElement.ProviderScope.providerType:type_name -> common_dto.EntityDTO.EntityType
	49, // 57: common_dto.ActionPolicyDTO.ActionPolicyElement.CommodityScope.commodityType:type_name -> common_dto.CommodityDTO.CommodityType
	50, // 58: common_dto.ActionMergePolicyDTO.EntityFilter.containerPodData:type_name -> common_dto.EntityDTO.ContainerPodData
	51, // 59: common_dto.ActionMergeTargetData.EntityRelationship.connectionType:type_name -> common_dto.ConnectedEntity.ConnectionType
	12, // 60: common_dto.ChainedActionMergeTargetData.TargetDataLink.merge_target:type_name -> common_dto.ActionMergeTargetData
	49, // 61: common_dto.ResizeMergeSpec.CommodityMergeData.commodity_type:type_name -> common_dto.CommodityDTO.CommodityType
	5,  // 62: common_dto.ResizeMergeSpec.CommodityMergeData.changed_attr:type_name -> common_dto.ActionItemDTO.CommodityAttribute
	49, // 63: common_dto.ScaleMergeSpec.CommodityMergeData.commodity_type:type_name -> common_dto.CommodityDTO.CommodityType
	5,  // 64: common_dto.ScaleMergeSpec.CommodityMergeData.changed_attr:type_name -> common_dto.ActionItemDTO.CommodityAttribute
	49, // 65: common_dto.HorizontalScaleMergeSpec.CommodityMergeData.commodity_type:type_name -> common_dto.CommodityDTO.CommodityType
	5,  // 66: common_dto.HorizontalScaleMergeSpec.CommodityMergeData.changed_attr:type_name -> common_dto.ActionItemDTO.CommodityAttribute
	44, // 67: common_dto.ActionItemDTO.ProviderInfo.entityType:type_name -> common_dto.EntityDTO.EntityType
	7,  // 68: common_dto.ActionItemDTO.Risk.severity:type_name -> common_dto.ActionItemDTO.Risk.Severity
	6,  // 69: common_dto.ActionItemDTO.Risk.category:type_name -> common_dto.ActionItemDTO.Risk.Category
	49, // 70: common_dto.ActionItemDTO.Risk.affectedCommodity:type_name -> common_dto.CommodityDTO.CommodityType
	41, // 71: common_dto.ActionItemDTO.MergeEntityPolicy.merged_entities:type_name -> common_dto.ActionItemDTO.MergedEntity
...
func file_ActionExecution_proto_init() {
	...
	file_ActionExecution_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ActionExecution_proto_rawDesc), len(file_ActionExecution_proto_rawDesc)),
			NumEnums:      9,
			NumMessages:   35,
			NumExtensions: 0,
			NumServices:   0,

...
func (cb *CommodityDTOBuilder) Create() (*proto.CommodityDTO, error) {
	...
	if cb.storageLatencyData != nil {
		commodityDTO.CommodityData = &proto.CommodityDTO_StorageLatencyData_{
			StorageLatencyData: cb.storageLatencyData,
		}
	} else if cb.storageAccessData != nil {
		commodityDTO.CommodityData = &proto.CommodityDTO_StorageAccessData_{
			StorageAccessData: cb.storageAccessData,
		}
	} else if cb.vstoragePartitionData != nil {
		commodityDTO.CommodityData = &proto.CommodityDTO_VstoragePartitionData{
			VstoragePartitionData: cb.vstoragePartitionData,
		}
	}

	if cb.vCpuData != nil {
		commodityDTO.HotresizeData = &proto.CommodityDTO_VcpuData{
			VcpuData: cb.vCpuData,
		}
	} else if cb.vMemData != nil {
		commodityDTO.HotresizeData = &proto.CommodityDTO_VmemData{
			VmemData: cb.vMemData,
		}
	}

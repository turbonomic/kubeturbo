...
func (eb *EntityDTOBuilder) Create() (*proto.EntityDTO, error) {
	...
	if eb.storageData != nil {
		entityDTO.EntityData = &proto.EntityDTO_StorageData_{StorageData: eb.storageData}
	} else if eb.diskArrayData != nil {
		entityDTO.EntityData = &proto.EntityDTO_DiskArrayData_{DiskArrayData: eb.diskArrayData}
	} else if eb.applicationData != nil {
		entityDTO.EntityData = &proto.EntityDTO_ApplicationData_{ApplicationData: eb.applicationData}
	} else if eb.virtualMachineData != nil {
		entityDTO.EntityData = &proto.EntityDTO_VirtualMachineData_{VirtualMachineData: eb.virtualMachineData}
	} else if eb.physicalMachineData != nil {
		entityDTO.EntityData = &proto.EntityDTO_PhysicalMachineData_{PhysicalMachineData: eb.physicalMachineData}
	} else if eb.virtualDataCenterData != nil {
		entityDTO.EntityData = &proto.EntityDTO_VirtualDatacenterData_{VirtualDatacenterData: eb.virtualDataCenterData}
	} else if eb.storageControllerData != nil {
		entityDTO.EntityData = &proto.EntityDTO_StorageControllerData_{StorageControllerData: eb.storageControllerData}
	} else if eb.logicalPoolData != nil {
		entityDTO.EntityData = &proto.EntityDTO_LogicalPoolData_{LogicalPoolData: eb.logicalPoolData}
	} else if eb.serviceData != nil {
		entityDTO.EntityData = &proto.EntityDTO_ServiceData_{ServiceData: eb.serviceData}
	} else if eb.containerPodData != nil {
		entityDTO.EntityData = &proto.EntityDTO_ContainerPodData_{ContainerPodData: eb.containerPodData}
	} else if eb.containerData != nil {
		entityDTO.EntityData = &proto.EntityDTO_ContainerData_{ContainerData: eb.containerData}
	} else if eb.workloadControllerData != nil {
		entityDTO.EntityData = &proto.EntityDTO_WorkloadControllerData_{WorkloadControllerData: eb.workloadControllerData}
	} else if eb.namespaceData != nil {
		entityDTO.EntityData = &proto.EntityDTO_NamespaceData_{NamespaceData: eb.namespaceData}
	} else if eb.clusterData != nil {
		entityDTO.EntityData = &proto.EntityDTO_ContainerPlatformClusterData_{ContainerPlatformClusterData: eb.clusterData}
	} else if eb.containerSpecData != nil {
		entityDTO.EntityData = &proto.EntityDTO_ContainerSpecData_{ContainerSpecData: eb.containerSpecData}
	}

	if eb.virtualMachineRelatedData != nil {
		entityDTO.RelatedEntityData = &proto.EntityDTO_VirtualMachineRelatedData_{VirtualMachineRelatedData: eb.virtualMachineRelatedData}
	} else if eb.physicalMachineRelatedData != nil {
		entityDTO.RelatedEntityData = &proto.EntityDTO_PhysicalMachineRelatedData_{PhysicalMachineRelatedData: eb.physicalMachineRelatedData}
	} else if eb.storageControllerRelatedData != nil {
		entityDTO.RelatedEntityData = &proto.EntityDTO_StorageControllerRelatedData_{StorageControllerRelatedData: eb.storageControllerRelatedData}
	}

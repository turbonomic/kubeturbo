...
type SLOHorizontalScaleSpec struct {
	...
	// +kubebuilder:default:={{name:ResponseTime,value:2000},{name:ServiceTime,value:2000},{name:QueuingTime,value:2000},{name:ConcurrentQueries,value:50},{name:Transaction,value:10},{name:LLMCache, value:70}}
	// +kubebuilder:validation:MinItems:=1
	Objectives []SLOHorizontalScalePolicySetting `json:"objectives,omitempty"`

...
var (
	...
	affinityType           = proto.CommodityDTO_PEER_TO_PEER_AFFINITY
	antiAffinityType       = proto.CommodityDTO_PEER_TO_PEER_ANTI_AFFINITY
	...
	affinityTemplateCommWithKey     = &proto.TemplateCommodity{Key: &fakeKey, CommodityType: &affinityType}
	antiAffinityTemplateCommWithKey = &proto.TemplateCommodity{Key: &fakeKey, CommodityType: &antiAffinityType}
...
func (f *SupplyChainFactory) buildNodeMergedEntityMetadata() (*proto.MergedEntityMetadata, error) {
	...
	return mergedEntityMetadataBuilder.
		...
		PatchSoldMetadata(proto.CommodityDTO_SEGMENTATION, fieldsUsedCapacity).
		PatchSoldMetadata(proto.CommodityDTO_PEER_TO_PEER_AFFINITY, fieldsUsedCapacityPeak).
		PatchSoldMetadata(proto.CommodityDTO_PEER_TO_PEER_ANTI_AFFINITY, fieldsUsedCapacityPeak).
...
func (f *SupplyChainFactory) buildNodeSupplyBuilder() (*proto.TemplateDTO, error) {
	...
	nodeSupplyChainNodeBuilder = nodeSupplyChainNodeBuilder.
		...
		Sells(affinityTemplateCommWithKey).
		Sells(antiAffinityTemplateCommWithKey).
...
func (f *SupplyChainFactory) buildPodSupplyBuilder() (*proto.TemplateDTO, error) {
	...
	podSupplyChainNodeBuilder = podSupplyChainNodeBuilder.
		...
		Buys(affinityTemplateCommWithKey).
		Buys(antiAffinityTemplateCommWithKey).
...
func (f *SupplyChainFactory) buildVolumeMergedEntityMetadata() (*proto.MergedEntityMetadata, error) {
	...
	mergedEntityMetadataBuilder.PatchField(ActionEligibilityField, []string{}).
		...
		InternalMatchingProperty(volumeId).
		ExternalMatchingField(supplychain.SUPPLY_CHAIN_CONSTANT_ID, []string{}).
		ExternalMatchingProperty(path).
		ExternalMatchingProperty("LocalName") // TODO: switch to supplychain.LOCAL_NAME in turbo-sdk

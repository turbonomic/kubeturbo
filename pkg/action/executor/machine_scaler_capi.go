...
type ControllerUitilityInterface interface {
	getMinMaxReplicas() (minNodes int, maxNodes int)
...
// ------------------------------------------------------------------------------------------------------------------
//
// Get min max preconditions
func (controller *machineSetController) getMinMaxReplicas() (minNodes int, maxNodes int) {
...
func (controller *machineSetController) checkPreconditions() error {
	...
	minNodes, maxNodes := controller.getUtilityHelper().getMinMaxReplicas()

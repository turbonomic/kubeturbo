...
func (g *GitHubHandler) UpdateRemote(res *unstructured.Unstructured, replicas int64,
	podSpec map[string]interface{}, clusterId string,
) (WaitForCompletionFn, interface{}, error) {
...
func (g *GitHubHandler) pushCommit(ref *github.Reference, tree *github.Tree) (*github.Reference, error) {
	...
	newCommit, _, err := g.client.Git.CreateCommit(g.ctx, g.user, g.repo, commit, nil)
	if err != nil {
		return nil, err
	}

...
func TestGetContainerPod(t *testing.T) {
	...
	for _, test := range tests {
		podId, index, err := getContainerPod(test.input)
		if err != nil {
			t.Error(err)
		}
...
func TestGetContainerPod2(t *testing.T) {
	//1. good
	input := "1466089904-b2333a79-2901-11e7-a3d7-00505680effd-0"
	expectPodId := "1466089904-b2333a79-2901-11e7-a3d7-00505680effd"
	expectIndex := 0
	podId, index, err := getContainerPod(input)
	if err != nil {
		t.Error(err)
	}

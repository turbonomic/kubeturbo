...
func setupTest(scenario string) (*TestConfig, error) {
	...
	ValidateAndParseDetectors(spec.MasterNodeDetectors, spec.HANodeConfig, spec.AnnotationWhitelist)

	if spec.DaemonPodDetectors == nil {
		spec.DaemonPodDetectors = &DaemonPodDetectors{}
	}
	SetDaemonNamespaces(spec.DaemonPodDetectors.Namespaces)
	SetDaemonPods(spec.DaemonPodDetectors.PodNamePatterns)

...
func (builder *nodeEntityDTOBuilder) BuildEntityDTOs(nodes []*api.Node, nodesPods map[string][]string,
	hostnameSpreadWorkloads sets.String, otherSpreadPods sets.String, podsToControllers map[string]string, node2nodegroup map[string]sets.String) ([]*proto.EntityDTO, []string) {
...
func (builder *nodeEntityDTOBuilder) getAffinityCommoditiesSold(node *api.Node, nodesPods map[string][]string,
	...
	// hostnameSpreadWorkloads will be empty if NewAffinityProcessing is not enabled

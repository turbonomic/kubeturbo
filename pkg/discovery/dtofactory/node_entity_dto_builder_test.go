...
func Test_NodeEntityDTO(t *testing.T) {
	...
	nodeEntityDTOs, _ := nodeEntityDTOBuilder.BuildEntityDTOs([]*api.Node{node}, nodePods, nil, nil, nil, nil)
...
func Test_getSuspendProvisionSettingByNodeType(t *testing.T) {
	...
	nodeEntityDTOBuilder1 := NewNodeEntityDTOBuilder(metricsSink, stitchingManager1, nil)
	...
	nodeEntityDTOBuilder2 := NewNodeEntityDTOBuilder(metricsSink, stitchingManager2, nil)
	...
	nodeEntityDTOBuilder3 := NewNodeEntityDTOBuilder(metricsSink, stitchingManager3, nil)

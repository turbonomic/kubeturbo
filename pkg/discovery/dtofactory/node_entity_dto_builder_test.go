...
func TestNodeEntityDTO(t *testing.T) {
	...
	nodeEntityDTOs, _ := nodeEntityDTOBuilder.BuildEntityDTOs([]*api.Node{node}, nodePods, nil, nil)
...
func Test_getAffinityCommoditiesSold(t *testing.T) {
	...
	commodities := nodeEntityDTOBuilder.getAffinityCommoditiesSold(node, mockNodesPods, nil, nil)

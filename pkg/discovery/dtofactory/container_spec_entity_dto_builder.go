...
func (builder *containerSpecDTOBuilder) BuildDTOs() ([]*proto.EntityDTO, []string) {
	var result []*proto.EntityDTO
	var operatorControlledContainerSpecs []string
	...
	return result, operatorControlledContainerSpecs
}

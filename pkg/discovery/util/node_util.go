...
const (
	...
	EKSSpot         = "SPOT"
	// EKS windows instance
	WindowsOS = "windows"
)

// EKS Node pool label: alpha.eksctl.io/nodegroup-name or eks.amazonaws.com/nodegroup
var NodePoolEKSIdentifier = sets.NewString(
...
func isValidNodePoolLabel(label string) bool {
	return label == NodePoolAKS || label == NodePoolGKE || NodePoolEKSIdentifier.Has(label)
}

...
type Task struct {
	...
	node2nodegroup                      map[string]sets.String
...
func (t *Task) WithPodsWithLabelBasedAffinities(podsWithLabelBasedAffinities sets.String) *Task {
	t.podsWithLabelBasedAffinities = podsWithLabelBasedAffinities
	return t
}
...
// Assign the mapping of each node uuid to the list of nodegroups to which this node belongs
func (t *Task) WithNode2NodeGroup(node2nodegroup map[string]sets.String) *Task {
	t.node2nodegroup = node2nodegroup
	return t
}

// Assign the mapping of each node uuid to the list of nodegroups to which this node belongs
func (t *Task) WithPodNonHostnameAntiTermTopologyKeys(podNonHostnameAntiTermTopologyKeys map[string]sets.String) *Task {
	t.podNonHostnameAntiTermTopologyKeys = podNonHostnameAntiTermTopologyKeys
	return t
}

func (t *Task) WithAffinityMapper(mapper *podaffinity.AffinityMapper) *Task {
	t.affinityMapper = mapper
	return t
}

func (t *Task) WithTopologySpreadConstraintNodesToPods(topologySpreadConstraintNodesToPods map[string]sets.String) *Task {
	t.topologySpreadConstraintNodesToPods = topologySpreadConstraintNodesToPods
	return t
}

func (t *Task) WithORMHandler(ormHandler *resourcemapping.ORMHandler) *Task {
	t.ormHandler = ormHandler
	return t
}
...
func (t *Task) PodsWithLabelBasedAffinities() sets.String {
	return t.podsWithLabelBasedAffinities
}
...
func (t *Task) Node2NodeGroups() map[string]sets.String {
	return t.node2nodegroup
}

func (t *Task) PodNonHostnameAntiTermTopologyKeys() map[string]sets.String {
	return t.podNonHostnameAntiTermTopologyKeys
}

func (t *Task) TopologySpreadConstraintNodesToPods() map[string]sets.String {
	return t.topologySpreadConstraintNodesToPods
}

func (t *Task) AffinityMapper() *podaffinity.AffinityMapper {
	return t.affinityMapper
}

func (t *Task) ORMHandler() *resourcemapping.ORMHandler {
	return t.ormHandler
}
...
type TaskResult struct {
	...
	kubeVirtPodUids           []string
	kubeVirtContainerSpecUids []string
	unmovablePods             []string
}
...
func (r *TaskResult) KubeVirtPodUids() []string {
	return r.kubeVirtPodUids
}

func (r *TaskResult) KubeVirtContainerSpecUids() []string {
	return r.kubeVirtContainerSpecUids
}
...
func (r *TaskResult) UnmovablePods() []string {
	return r.unmovablePods
}
...
func (r *TaskResult) WithKubeVirtPodUids(kubeVirtPodUids []string) *TaskResult {
	r.kubeVirtPodUids = kubeVirtPodUids
	return r
}

func (r *TaskResult) WithKubeVirtContainerSpecUids(kubeVirtContainerSpecUids []string) *TaskResult {
	r.kubeVirtContainerSpecUids = kubeVirtContainerSpecUids
	return r
}

func (r *TaskResult) WithUnmovablePods(unmovablePods []string) *TaskResult {
	r.unmovablePods = unmovablePods
	return r
}

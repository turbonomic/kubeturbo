...
func (pr *PodAffinityProcessor) ProcessAffinities(allPods []*v1.Pod) (map[string][]string,
	sets.String, map[string]sets.String, sets.String, map[string]sets.String, map[string]sets.String) {
	...
	return nodesPods, podsWithSupportedAffinities, pr.hostnameSpreadWorkloads, pr.otherSpreadPods, pr.otherSpreadWorkloads, pr.podNonHostnameAntiTermTopologyKeys
}

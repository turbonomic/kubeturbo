...
func createSLOPolicy(
	...
	for _, setting := range spec.Objectives {
		...
		case v1alpha1.ServiceTime:
			settings.AddSetting(group.NewServiceTimeSLOPolicySetting(settingValue))
		case v1alpha1.QueuingTime:
			settings.AddSetting(group.NewQueuingTimeSLOPolicySetting(settingValue))
		case v1alpha1.ConcurrentQueries:
			settings.AddSetting(group.NewConcurrentQueriesSLOPolicySetting(settingValue))
		case v1alpha1.LLMCache:
			settings.AddSetting(group.NewLlmCacheSLOPolicySetting(settingValue))
		default:
